...
.ow-title { display: flex; align-items: center; gap: 9px; font-size: var(--ff-fs-h3); font-weight: 700; color: var(--ff-text-primary); }
...
.ow-step { display: inline-flex; align-items: center; gap: 6px; font-size: var(--ff-fs-caption); color: var(--ff-text-3); font-weight: 600; }
.ow-step.on { color: var(--ff-brand-dark); }
.ow-step.done { color: var(--ff-brand); }
.ow-dot { width: 19px; height: 19px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; font-size: var(--ff-fs-xs); background: var(--ff-bg-subtle); color: var(--ff-text-3); }
...
.ow-desc { font-size: var(--ff-fs-caption); color: var(--ff-text-secondary); margin-bottom: 15px; }
...
.ow-pname { font-size: var(--ff-fs-caption); font-weight: 600; color: var(--ff-text-primary); }
.ow-pmodel { font-size: var(--ff-fs-xs); color: var(--ff-text-3); font-family: var(--ff-font-mono, ui-monospace, monospace); }
.ow-grid2 { display: grid; grid-template-columns: 1fr 1fr; gap: 0 16px; }
.ow-field { margin-bottom: 14px; }
.ow-field label { display: block; font-size: var(--ff-fs-caption); font-weight: 600; color: var(--ff-text-secondary); margin-bottom: 6px; }
...
.ow-input { width: 100%; height: 40px; border: 1px solid var(--ff-border); border-radius: 10px; padding: 0 13px; font-size: var(--ff-fs-caption); outline: none; background: var(--ff-bg-surface); color: var(--ff-text-primary); transition: border-color 120ms, box-shadow 120ms; font-family: inherit; }
.ow-input:focus { border-color: var(--ff-border-focus); box-shadow: 0 0 0 3px var(--ff-focus-ring); }
.ow-check { font-size: var(--ff-fs-caption); color: var(--ff-text-primary); cursor: pointer; }
.ow-check input { width: 15px; height: 15px; accent-color: var(--ff-brand); }
.ow-test { font-size: var(--ff-fs-caption); color: var(--ff-brand); margin: 4px 0 10px; }
