...
.tv__tab { border: none; background: none; border-radius: 8px; padding: 6px 15px; font-size: var(--ff-fs-caption); font-weight: 600; color: var(--ff-text-2); cursor: pointer; }
.tv__tab.on { background: var(--ff-bg-surface); color: var(--ff-brand-dark); box-shadow: 0 1px 3px rgba(16, 40, 30, 0.12); }
.tv__sp { flex: 1; }
.tv__retry-all { display: inline-flex; align-items: center; gap: 6px; border: 1px solid var(--ff-up-border); background: var(--ff-up-subtle); color: var(--ff-up); border-radius: 9px; padding: 7px 13px; font-size: var(--ff-fs-caption); font-weight: 600; cursor: pointer; }
...
.tv__badge { display: inline-flex; align-items: center; gap: 6px; font-size: var(--ff-fs-xs); font-weight: 600; padding: 3px 10px; border-radius: 10px; }
...
.tv__name { font-size: var(--ff-fs-caption); font-weight: 600; color: var(--ff-text-primary); }
.tv__model { font-size: var(--ff-fs-xs); color: var(--ff-text-3); font-family: var(--ff-font-mono, ui-monospace, monospace); }
.tv__time, .tv__elapsed { font-size: var(--ff-fs-xs); color: var(--ff-text-3); }
...
.tv__stream-head { display: flex; align-items: center; gap: 7px; font-size: var(--ff-fs-xs); font-weight: 600; color: var(--ff-brand-dark); padding: 8px 12px; background: var(--ff-bg-brand-subtle); }
.tv__stream-dot { width: 7px; height: 7px; border-radius: 50%; background: var(--ff-brand); animation: tv-pulse 1.2s infinite; }
.tv__stream-body { max-height: 62vh; overflow-y: auto; padding: 4px 16px 14px; font-size: var(--ff-fs-body-sm); }
...
.tv__msg { font-size: var(--ff-fs-caption); color: var(--ff-text-2); }
.tv__errmsg { font-size: var(--ff-fs-caption); color: var(--ff-up); }
.tv__ops { display: flex; gap: 6px; }
.tv__op { display: inline-flex; align-items: center; gap: 5px; border: 1px solid var(--ff-border); background: var(--ff-bg-surface); border-radius: 8px; padding: 6px 12px; font-size: var(--ff-fs-xs); font-weight: 600; color: var(--ff-text-2); cursor: pointer; }
...
.tv__empty p { font-size: var(--ff-fs-body-sm); margin: 10px 0 4px; }
.tv__empty-sub { font-size: var(--ff-fs-xs) !important; margin: 0 !important; }
...
.tv__log-head { display: flex; align-items: center; justify-content: space-between; font-size: var(--ff-fs-body-sm); font-weight: 700; margin-bottom: 14px; }
...
.tv__log-kv { display: flex; gap: 12px; padding: 8px 0; border-bottom: 1px dashed var(--ff-border); font-size: var(--ff-fs-caption); }
