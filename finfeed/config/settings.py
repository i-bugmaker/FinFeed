...
SOURCE_TIERS: Dict[str, int] = {
    ...
    "格隆汇文章": 6, "法布财经": 6, "第一财经": 6,
    "21经济网": 12, "中证快讯": 6,
    "集思录": 6,
    "财新网": 1, "汇通网快讯": 1, "新浪财经7×24": 1, "富途牛牛快讯": 6, "英为财情": 6,
    "上交所公告": 6, "深交所公告": 6, "东方财富研报": 12,
...
SOURCE_PRIORITY: Dict[str, int] = {
    ...
    "火星财经": 58,
    "英为财情": 60, "上交所公告": 92, "深交所公告": 92, "东方财富研报": 70,
...
# 补抓防饿死加固（2026-08-24）：
# - 连续 N 轮补抓零新增即提前终止，切回实时主循环；
# - 单次补抓总耗时超过硬上限（秒）强制切回实时轮次，避免慢源拖垮主循环。
CATCH_UP_ZERO_STREAK_LIMIT: int = 2
CATCH_UP_HARD_TIMEOUT: int = 300
